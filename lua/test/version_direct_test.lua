...
describe("VersionDirect", function()
  it("should direct-list-version", function()
    local setup = version_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-version", setup.live and "live" or "unit")
