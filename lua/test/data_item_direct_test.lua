...
describe("DataItemDirect", function()
  it("should direct-load-data_item", function()
    local setup = data_item_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-data_item", setup.live and "live" or "unit")
...
function data_item_direct_setup(mockres)
