...
describe("DataRuneDirect", function()
  it("should direct-load-data_rune", function()
    local setup = data_rune_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-data_rune", setup.live and "live" or "unit")
...
function data_rune_direct_setup(mockres)
