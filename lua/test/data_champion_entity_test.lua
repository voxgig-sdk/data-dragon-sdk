...
describe("DataChampionEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DATA_DRAGON_TEST_DATA_CHAMPION_ENTID JSON to run live")
      return
    end
...
function data_champion_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DATA_DRAGON_TEST_DATA_CHAMPION_ENTID")
