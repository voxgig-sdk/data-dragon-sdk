...
describe("ChampionDirect", function()
  it("should direct-load-champion", function()
    local setup = champion_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-champion", setup.live and "live" or "unit")
...
function champion_direct_setup(mockres)
