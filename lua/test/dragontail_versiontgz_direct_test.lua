-- DragontailVersiontgz direct test
...
describe("DragontailVersiontgzDirect", function()
  it("should direct-load-dragontail_versiontgz", function()
    local setup = dragontail_versiontgz_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dragontail_versiontgz", setup.live and "live" or "unit")
...
function dragontail_versiontgz_direct_setup(mockres)
