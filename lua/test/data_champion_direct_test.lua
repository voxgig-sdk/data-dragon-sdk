...
describe("DataChampionDirect", function()
  it("should direct-load-data_champion", function()
    local setup = data_champion_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-data_champion", setup.live and "live" or "unit")
...
function data_champion_direct_setup(mockres)
