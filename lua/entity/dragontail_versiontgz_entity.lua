...
local DragontailVersiontgzEntity = {}
DragontailVersiontgzEntity.__index = DragontailVersiontgzEntity


function DragontailVersiontgzEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DragontailVersiontgzEntity)
  self._name = "dragontail_versiontgz"
  self._client = client
...
function DragontailVersiontgzEntity:get_name()
  return self._name
end


function DragontailVersiontgzEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DragontailVersiontgzEntity.new(self._client, opts)
end
...
function DragontailVersiontgzEntity:mark_deleted()
  self._deleted = true
end


function DragontailVersiontgzEntity:deleted()
  return true == self._deleted
end


function DragontailVersiontgzEntity:data_set(args)
  if args ~= nil then
...
function DragontailVersiontgzEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DragontailVersiontgzEntity:match_set(args)
  if args ~= nil then
...
function DragontailVersiontgzEntity:match_get()
...
function DragontailVersiontgzEntity:stream(action, args, callopts)
...
function DragontailVersiontgzEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DragontailVersiontgzEntity
