...
AQL-driven CLI and REPL for the DataDragon SDK. Positional arguments are
...
./data-dragon-cli list champion
./data-dragon-cli load 1 champion
./data-dragon-cli load '{id:1}' champion
