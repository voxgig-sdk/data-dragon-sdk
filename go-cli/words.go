...
func registerSDKWords(r *eng.Registry, client *sdk.DataDragonSDK) {
...
func runOp(client *sdk.DataDragonSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
