...
class DataRuneEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DATA_DRAGON_TEST_DATA_RUNE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $data_rune_ref01_data_dt0_loaded = $data_rune_ref01_ent->load($data_rune_ref01_match_dt0, null);
...
function data_rune_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DATA_DRAGON_TEST_DATA_RUNE_ENTID");
