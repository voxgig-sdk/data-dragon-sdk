...
// DataDragon SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DataDragonSDK::test)
...
{
    private const SDK_CLASS = 'DataDragonSDK';
    ...
    private const SDK_BASE = 'datadragon_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../datadragon_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
