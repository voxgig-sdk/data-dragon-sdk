...
class ChampionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DATA_DRAGON_TEST_CHAMPION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function champion_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DATA_DRAGON_TEST_CHAMPION_ENTID");
