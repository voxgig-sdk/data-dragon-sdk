...
class DataItemDirectTest extends TestCase
{
    public function test_direct_load_data_item(): void
    {
        $setup = data_item_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-data_item", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
