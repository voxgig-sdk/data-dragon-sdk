...
class DataRuneDirectTest extends TestCase
{
    public function test_direct_load_data_rune(): void
    {
        $setup = data_rune_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-data_rune", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
