...
class DataChampionDirectTest extends TestCase
{
    public function test_direct_load_data_champion(): void
    {
        $setup = data_champion_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-data_champion", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
