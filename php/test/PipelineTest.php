...
{
    private static function utility(): DataDragonUtility
    {
        return new DataDragonUtility();
    }
    ...
    private static function ctx(array $over = []): DataDragonContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DataDragonContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DataDragonOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DataDragonError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DataDragonOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DataDragonMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DataDragonOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DataDragonMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DataDragonOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DataDragonMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DataDragonSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DataDragonMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DataDragonResponse([]),
            'result' => new DataDragonResult([]),
        ]);
        [, $err] = DataDragonMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DataDragonSpec([]),
            'response' => null,
            'result' => new DataDragonResult([]),
        ]);
        [, $err] = DataDragonMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DataDragonSpec(['step' => 's']),
            'response' => new DataDragonResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DataDragonResult([]),
        ]);
        [, $err] = DataDragonMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DataDragonSpec(['step' => 's']),
            'response' => new DataDragonResponse(self::resp(200, ['v' => 1])),
            'result' => new DataDragonResult([]),
        ]);
        [, $err] = DataDragonMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DataDragonSpec(['step' => 's']),
            'response' => new DataDragonResponse(self::resp(200, ['v' => 2])),
            'result' => new DataDragonResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DataDragonMakeResponse::call($ctx);
    ...
    {
        $preset = new DataDragonResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DataDragonSpec([]),
            'response' => new DataDragonResponse([]),
            'result' => new DataDragonResult([]),
        ...
        [$got, $err] = DataDragonMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DataDragonResult([])]);
        [, $err] = DataDragonMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DataDragonSpec([]), 'result' => null]);
        [, $err] = DataDragonMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DataDragonSpec(['step' => 's']),
            'result' => new DataDragonResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DataDragonOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DataDragonMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DataDragonSpec(['step' => 's']),
            'result' => new DataDragonResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DataDragonOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DataDragonMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DataDragonResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DataDragonSpec([]),
            'result' => new DataDragonResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DataDragonMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DataDragonMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DataDragonError('boom', 'boom');
        $utility->fetcher = function (DataDragonContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DataDragonSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DataDragonMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DataDragonContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DataDragonMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DataDragonResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        DataDragonMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DataDragonContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DataDragonSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DataDragonMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DataDragonResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DataDragonSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DataDragonMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DataDragonMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DataDragonMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DataDragonResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DataDragonDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DataDragonResult(['ok' => false])]);
        $this->expectException(DataDragonError::class);
        DataDragonDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DataDragonResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DataDragonMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DataDragonMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DataDragonBaseFeature();
        $b = new DataDragonBaseFeature();
        DataDragonFeatureAdd::call($ctx, $a);
        DataDragonFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DataDragonBaseFeature
    {
        $f = new DataDragonBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DataDragonFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DataDragonContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DataDragonSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DataDragonPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        DataDragonPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DataDragonResponse(['headers' => null]),
            'result' => new DataDragonResult([]),
        ]);
        DataDragonResultHeaders::call($ctx);
