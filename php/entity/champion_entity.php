...
class ChampionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ChampionEntity($this->_client, $opts);
    }

    /**
     * @param Champion|array $args Champion data (assoc-array) to store.
     */
    ...
    /**
     * @return Champion|array The current Champion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Champion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Champion fields).
     */
     ...
     *
     * @param ChampionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ChampionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Champion|array The loaded Champion as an assoc-array at the
