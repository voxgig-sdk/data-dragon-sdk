...
class DataDragonProxyFeature extends DataDragonBaseFeature
{
    ...
    public function init(DataDragonContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DataDragonContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
