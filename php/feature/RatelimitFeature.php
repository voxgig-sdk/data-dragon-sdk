...
// DataDragon SDK ratelimit feature
...
class DataDragonRatelimitFeature extends DataDragonBaseFeature
{
    ...
    private function _acquire(DataDragonContext $ctx): void
    {
    ...
    private function _track(DataDragonContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
