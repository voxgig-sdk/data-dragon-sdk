...
// DataDragon SDK idempotency feature
...
class DataDragonIdempotencyFeature extends DataDragonBaseFeature
{
    ...
    private function _mutating(DataDragonContext $ctx): bool
    {
