...
class DataDragonRbacFeature extends DataDragonBaseFeature
{
    ...
    private function _required(DataDragonContext $ctx): ?string
    {
    ...
    private function _reject(DataDragonContext $ctx, string $required): void
    {
    ...
    private function _track(DataDragonContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
