...
// DataDragon SDK streaming feature
...
class DataDragonStreamingFeature extends DataDragonBaseFeature
{
    ...
    private function _iterate(DataDragonResult $result): \Generator
    {
    ...
    private function _streamable(DataDragonContext $ctx): bool
    {
