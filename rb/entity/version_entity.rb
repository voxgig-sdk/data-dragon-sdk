...
class VersionEntity
  ...
  #
  # @param reqmatch [VersionListMatch, Hash, nil] match filter (any subset of
  #   Version fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Version>, Array] the matching Version items; raises DataDragonError on failure
