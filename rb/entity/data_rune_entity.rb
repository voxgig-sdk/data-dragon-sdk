...
class DataRuneEntity
  ...
  def make
    opts = @_entopts.dup
    DataRuneEntity.new(@_client, opts)
  end
  ...
  # @return [DataRune, Hash] the current DataRune data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DataRune fields)
  def match_get
  ...
  #
  # @param reqmatch [DataRuneLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.DataRune.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [DataRune, Hash] the loaded DataRune; raises DataDragonError on failure
