...
class DataItemEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DATADRAGON_TEST_DATA_ITEM_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def data_item_basic_setup(extra)
  ...
  entid_env_raw = ENV["DATADRAGON_TEST_DATA_ITEM_ENTID"]
