...
describe('DataItemEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let data_item_ref01_data = Object.values(setup.data.existing.data_item)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/data_item/DataItemTestData.json')
  ...
  let idmap = transform(
    ['data_item01','data_item02','data_item03','cdn01','cdn02','cdn03','data01','data02','data03'],
    {
      '`$PACK`': ['', {
        '`$KEY`': '`$COPY`',
