...
(0, node_test_1.describe)('ChampionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-champion', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-champion', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DATA_DRAGON_TEST_CHAMPION_ENTID'];
...
//# sourceMappingURL=ChampionDirect.test.js.map