...
(0, node_test_1.describe)('DataItemEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.DataItem();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.DATA_DRAGON_TEST_LIVE;
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'data_item.' + op, live))
                return;
        }
        ...
        let data_item_ref01_data = Object.values(setup.data.existing.data_item)[0];
        // LOAD: skipped — no entity id field and load requires path params.
        // Entity-var is declared here so later flow steps still compile.
        const data_item_ref01_ent = client.DataItem();
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/data_item/DataItemTestData.json');
    ...
    let idmap = transform(['data_item01', 'data_item02', 'data_item03', 'cdn01', 'cdn02', 'cdn03', 'data01', 'data02', 'data03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['DATA_DRAGON_TEST_DATA_ITEM_ENTID'];
...
//# sourceMappingURL=DataItemEntity.test.js.map