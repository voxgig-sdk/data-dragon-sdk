...
(0, node_test_1.describe)('DataItemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-data_item', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-data_item', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'DATA_DRAGON_TEST_DATA_ITEM_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['DATA_DRAGON_TEST_DATA_ITEM_ENTID'];
...
//# sourceMappingURL=DataItemDirect.test.js.map