...
(0, node_test_1.describe)('DragontailVersiontgzEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'dragontail_versiontgz.' + op, live))
                return;
        }
        ...
        let dragontail_versiontgz_ref01_data = Object.values(setup.data.existing.dragontail_versiontgz)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/dragontail_versiontgz/DragontailVersiontgzTestData.json');
    ...
    let idmap = transform(['dragontail_versiontgz01', 'dragontail_versiontgz02', 'dragontail_versiontgz03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DragontailVersiontgzEntity.test.js.map