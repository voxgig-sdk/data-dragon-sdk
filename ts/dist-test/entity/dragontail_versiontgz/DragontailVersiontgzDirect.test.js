...
(0, node_test_1.describe)('DragontailVersiontgzDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DataDragonSDK({
    ...
    (0, node_test_1.test)('direct-load-dragontail_versiontgz', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dragontail_versiontgz', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.DATA_DRAGON_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DataDragonSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DATA_DRAGON_TEST_DRAGONTAIL_VERSIONTGZ_ENTID'];
    ...
    const client = new __1.DataDragonSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DragontailVersiontgzDirect.test.js.map