...
(0, node_test_1.describe)('DataRuneEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'data_rune.' + op, live))
                return;
        }
        ...
        let data_rune_ref01_data = Object.values(setup.data.existing.data_rune)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/data_rune/DataRuneTestData.json');
    ...
    let idmap = transform(['data_rune01', 'data_rune02', 'data_rune03', 'cdn01', 'cdn02', 'cdn03', 'data01', 'data02', 'data03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DataRuneEntity.test.js.map