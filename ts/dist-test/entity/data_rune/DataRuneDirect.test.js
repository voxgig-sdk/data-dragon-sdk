...
(0, node_test_1.describe)('DataRuneDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-data_rune', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-data_rune', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DATA_DRAGON_TEST_DATA_RUNE_ENTID'];
...
//# sourceMappingURL=DataRuneDirect.test.js.map