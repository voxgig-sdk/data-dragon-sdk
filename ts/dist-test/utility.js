...
function envOverride(m) {
    if ('TRUE' === process.env.DATA_DRAGON_TEST_LIVE ||
        'TRUE' === process.env.DATA_DRAGON_TEST_OVERRIDE) {
    ...
    m.DATA_DRAGON_TEST_EXPLAIN = process.env.DATA_DRAGON_TEST_EXPLAIN || m.DATA_DRAGON_TEST_EXPLAIN;
    return m;
}
