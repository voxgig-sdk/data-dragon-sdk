...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/data-dragon` | `npm install @voxgig-sdk/data-dragon` |
| Python | `voxgig-sdk-data-dragon` | `pip install voxgig-sdk-data-dragon` |
| PHP | `voxgig-sdk/data-dragon` | `composer require voxgig-sdk/data-dragon` |
| Golang | `github.com/voxgig-sdk/data-dragon-sdk/go` | `go get github.com/voxgig-sdk/data-dragon-sdk/go` |
| Ruby | `voxgig-sdk-data-dragon` | `gem install voxgig-sdk-data-dragon` |
| Lua | `voxgig-sdk-data-dragon` | `luarocks install voxgig-sdk-data-dragon` |
