// Command DataDragon-mcp is an MCP server exposing the DataDragon
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DataDragon_list  — list records of an entity
//	DataDragon_load  — load a single record of an entity
//
