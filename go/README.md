...
```bash
go mod edit -replace github.com/voxgig-sdk/data-dragon-sdk/go=../path/to/github.com/voxgig-sdk/data-dragon-sdk/go
```
...
```
github.com/voxgig-sdk/data-dragon-sdk/go/
...
The root package (`github.com/voxgig-sdk/data-dragon-sdk/go`) re-exports everything needed
