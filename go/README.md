# DataDragon Golang SDK

The Golang SDK for the DataDragon API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/data-dragon-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/data-dragon-sdk=../path/to/github.com/voxgig-sdk/data-dragon-sdk
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *DataDragonSDK
```
...
| `Champion` | `(data map[string]any) DataDragonEntity` | Create a Champion entity instance. |
| `DataChampion` | `(data map[string]any) DataDragonEntity` | Create a DataChampion entity instance. |
...
### Entity interface (DataDragonEntity)

All entities implement the `DataDragonEntity` interface.
...
Create an instance: `champion := client.Champion(nil)`
...
```
github.com/voxgig-sdk/data-dragon-sdk/
├── data-dragon.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/data-dragon-sdk`) re-exports everything needed
