...
const testSeed = `map[string]any{"entity": map[string]any{"champion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_champion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_rune": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dragontail_versiontgz": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "region": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "version": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
