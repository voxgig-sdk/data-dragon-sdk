...
func NewDataRuneEntity(client *core.DataDragonSDK, entopts map[string]any) *DataRuneEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataRuneEntity) GetName() string { return e.name }
...
func (e *DataRuneEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataRuneEntity) Deleted() bool {
	return e.deleted
}


func (e *DataRuneEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataRuneEntity(e.client, opts)
}

func (e *DataRuneEntity) Data(args ...any) any {
...
func (e *DataRuneEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DataRune; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DataRuneEntity) DataTyped(data ...DataRune) DataRune {
	if len(data) > 0 {
		return typedFrom[DataRune](e.Data(asMap(data[0])))
	}
	return typedFrom[DataRune](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DataRune (all fields
// optional at the wire level).
func (e *DataRuneEntity) MatchTyped(match ...DataRune) DataRune {
	if len(match) > 0 {
		return typedFrom[DataRune](e.Match(asMap(match[0])))
	}
	return typedFrom[DataRune](e.Match())
}
...
func (e *DataRuneEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataRuneEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DataRuneLoadMatch and returns an DataRune. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DataRuneEntity) LoadTyped(reqmatch DataRuneLoadMatch, ctrl map[string]any) (DataRune, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DataRune{}, err
	}
	return typedFrom[DataRune](res), nil
}



func (e *DataRuneEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DataRuneEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DataRuneEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataRuneEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataRuneEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
