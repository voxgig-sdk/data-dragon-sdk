...
type DataChampionEntity struct {
	name    string
	client  *core.DataDragonSDK
...
func NewDataChampionEntity(client *core.DataDragonSDK, entopts map[string]any) *DataChampionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataChampionEntity) GetName() string { return e.name }
...
func (e *DataChampionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataChampionEntity) Deleted() bool {
	return e.deleted
}


func (e *DataChampionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataChampionEntity(e.client, opts)
}

func (e *DataChampionEntity) Data(args ...any) any {
...
func (e *DataChampionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DataChampion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DataChampionEntity) DataTyped(data ...DataChampion) DataChampion {
	if len(data) > 0 {
		return typedFrom[DataChampion](e.Data(asMap(data[0])))
	}
	return typedFrom[DataChampion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DataChampion (all fields
// optional at the wire level).
func (e *DataChampionEntity) MatchTyped(match ...DataChampion) DataChampion {
	if len(match) > 0 {
		return typedFrom[DataChampion](e.Match(asMap(match[0])))
	}
	return typedFrom[DataChampion](e.Match())
}
...
func (e *DataChampionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataChampionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DataChampionLoadMatch and returns an DataChampion. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DataChampionEntity) LoadTyped(reqmatch DataChampionLoadMatch, ctrl map[string]any) (DataChampion, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DataChampion{}, err
	}
	return typedFrom[DataChampion](res), nil
}



func (e *DataChampionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DataChampionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DataChampionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataChampionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataChampionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
