...
func NewDataItemEntity(client *core.DataDragonSDK, entopts map[string]any) *DataItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataItemEntity) GetName() string { return e.name }
...
func (e *DataItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataItemEntity) Deleted() bool {
	return e.deleted
}


func (e *DataItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataItemEntity(e.client, opts)
}

func (e *DataItemEntity) Data(args ...any) any {
...
func (e *DataItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DataItem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DataItemEntity) DataTyped(data ...DataItem) DataItem {
	if len(data) > 0 {
		return typedFrom[DataItem](e.Data(asMap(data[0])))
	}
	return typedFrom[DataItem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DataItem (all fields
// optional at the wire level).
func (e *DataItemEntity) MatchTyped(match ...DataItem) DataItem {
	if len(match) > 0 {
		return typedFrom[DataItem](e.Match(asMap(match[0])))
	}
	return typedFrom[DataItem](e.Match())
}
...
func (e *DataItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataItemEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DataItemLoadMatch and returns an DataItem. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DataItemEntity) LoadTyped(reqmatch DataItemLoadMatch, ctrl map[string]any) (DataItem, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DataItem{}, err
	}
	return typedFrom[DataItem](res), nil
}



func (e *DataItemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DataItemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DataItemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataItemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
