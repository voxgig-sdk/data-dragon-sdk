...
func NewChampionEntity(client *core.DataDragonSDK, entopts map[string]any) *ChampionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ChampionEntity) GetName() string { return e.name }
...
func (e *ChampionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ChampionEntity) Deleted() bool {
	return e.deleted
}


func (e *ChampionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewChampionEntity(e.client, opts)
}

func (e *ChampionEntity) Data(args ...any) any {
...
func (e *ChampionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Champion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ChampionEntity) DataTyped(data ...Champion) Champion {
	if len(data) > 0 {
		return typedFrom[Champion](e.Data(asMap(data[0])))
	}
	return typedFrom[Champion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Champion (all fields
// optional at the wire level).
func (e *ChampionEntity) MatchTyped(match ...Champion) Champion {
	if len(match) > 0 {
		return typedFrom[Champion](e.Match(asMap(match[0])))
	}
	return typedFrom[Champion](e.Match())
}
...
func (e *ChampionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ChampionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ChampionLoadMatch and returns an Champion. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ChampionEntity) LoadTyped(reqmatch ChampionLoadMatch, ctrl map[string]any) (Champion, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Champion{}, err
	}
	return typedFrom[Champion](res), nil
}



func (e *ChampionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ChampionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ChampionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ChampionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ChampionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
