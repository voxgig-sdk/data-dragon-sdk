...
type DragontailVersiontgzEntity struct {
	name    string
...
func NewDragontailVersiontgzEntity(client *core.DataDragonSDK, entopts map[string]any) *DragontailVersiontgzEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DragontailVersiontgzEntity) GetName() string { return e.name }
...
func (e *DragontailVersiontgzEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DragontailVersiontgzEntity) Deleted() bool {
	return e.deleted
}


func (e *DragontailVersiontgzEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDragontailVersiontgzEntity(e.client, opts)
}

func (e *DragontailVersiontgzEntity) Data(args ...any) any {
...
func (e *DragontailVersiontgzEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DragontailVersiontgzEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DragontailVersiontgzEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DragontailVersiontgzEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DragontailVersiontgzEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DragontailVersiontgzEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DragontailVersiontgzEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
