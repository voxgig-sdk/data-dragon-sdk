...
import (
	...
	"github.com/voxgig-sdk/data-dragon-sdk/go/entity"
	"github.com/voxgig-sdk/data-dragon-sdk/go/feature"
	_ "github.com/voxgig-sdk/data-dragon-sdk/go/utility"
)
...
// instead of `sdk.NewDataDragonSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *DataDragonSDK  { return NewDataDragonSDK(nil) }
func Test() *DataDragonSDK { return TestSDK(nil, nil) }
