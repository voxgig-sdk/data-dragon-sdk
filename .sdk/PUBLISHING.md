...
|---|---|---|
| `ts/` | @voxgig-sdk/data-dragon-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/data-dragon-sdk \
      --repository voxgig-sdk/data-dragon-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/data-dragon-sdk` shows it, and
`npm trust revoke @voxgig-sdk/data-dragon-sdk --id=<id>` removes it.
