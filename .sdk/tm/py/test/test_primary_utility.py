...
from projectname_sdk import DataDragonSDK
from projectname_sdk.core.spec import DataDragonSpec
from projectname_sdk.core.result import DataDragonResult
from projectname_sdk.core.response import DataDragonResponse
from projectname_sdk.core.operation import DataDragonOperation
from projectname_sdk.core.error import DataDragonError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import DataDragonBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return DataDragonError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DataDragonSDK.test(None, None)
        ...
        class TestInitFeature(DataDragonBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DataDragonBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DataDragonSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DataDragonSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DataDragonSDK.test(None, setup_opts)
