...
from projectname_sdk.core.control import DataDragonControl
...
class DataDragonContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, DataDragonSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DataDragonResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DataDragonResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DataDragonError(code, msg, self)
