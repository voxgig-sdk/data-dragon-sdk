# DataDragon SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, DataDragonError):
        errmsg = err.msg
    ...
    msg = "DataDragonSDK: " + opname + ": " + errmsg
    ...
    sdk_err = DataDragonError("", msg, ctx)
