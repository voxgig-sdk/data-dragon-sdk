...
// DataDragon SDK utility: graphql
//
...
class DataDragonGraphql
{
    ...
    // equivalent.
    public static function body(DataDragonContext $ctx): mixed
    {
    ...
    public static function errors(DataDragonContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
