...
// DataDragon SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DataDragonMakeRequest
{
    public static function call(DataDragonContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DataDragonResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DataDragonResponse($fetched);
        } else {
