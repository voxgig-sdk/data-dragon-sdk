...
// DataDragon SDK utility: fetcher
...
class DataDragonFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DataDragonSDK/1.0)';
    ...
    public static function call(DataDragonContext $ctx, string $fullurl, array $fetchdef): array
    {
