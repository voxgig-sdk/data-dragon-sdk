...
// DataDragon SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DataDragonOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DataDragonOmni::structfix($now, Struct::undef()))
                        !== json_encode(DataDragonOmni::structfix($val, Struct::undef()))) {
