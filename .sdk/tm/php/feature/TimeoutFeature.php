...
// DataDragon SDK timeout feature
...
class DataDragonTimeoutFeature extends DataDragonBaseFeature
{
    ...
    private function _with_timeout(DataDragonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DataDragonContext $_ctx, float $ms): void
    {
        $client = $this->client;
