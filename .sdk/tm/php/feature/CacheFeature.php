...
class DataDragonCacheFeature extends DataDragonBaseFeature
{
    ...
    private function _through(DataDragonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
