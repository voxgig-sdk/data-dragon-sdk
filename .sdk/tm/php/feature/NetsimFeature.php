...
class DataDragonNetsimFeature extends DataDragonBaseFeature
{
    ...
    private function _simulate(DataDragonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DataDragonContext $ctx, array $applied): void
    {
        $client = $this->client;
