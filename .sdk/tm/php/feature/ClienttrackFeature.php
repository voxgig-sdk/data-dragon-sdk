...
// DataDragon SDK clienttrack feature
...
class DataDragonClienttrackFeature extends DataDragonBaseFeature
{
    ...
    public function PostConstruct(DataDragonContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DataDragon-SDK';
