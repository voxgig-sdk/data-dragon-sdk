...
// DataDragon SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DataDragonTestFeature extends DataDragonBaseFeature
{
    ...
    public function init(DataDragonContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DataDragonContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DataDragonParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DataDragonContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DataDragonContext $ctx, $op, $args): array
    {
