...
class DataDragonTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DataDragonTestRunner.getenv("DATADRAGON_TEST_LIVE")
        override = DataDragonTestRunner.getenv("DATADRAGON_TEST_OVERRIDE")
        ...
        explain = DataDragonTestRunner.getenv("DATADRAGON_TEST_EXPLAIN")
