    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set DATA_DRAGON_TEST_DATA_CHAMPION_ENTID JSON to run live")
        client = setup["client"]
        ...
        data_champion_ref01_data_dt0_loaded = data_champion_ref01_ent.load(data_champion_ref01_match_dt0, None)
...
def _data_champion_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("DATA_DRAGON_TEST_DATA_CHAMPION_ENTID"))
