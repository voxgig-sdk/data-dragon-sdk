# DataDragon SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DataDragonSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DataDragonSDK(...) and DataDragonSDK.test(...) become
#      DataDragonSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "datadragon_sdk"
_SDK_CLASS = "DataDragonSDK"
...
_ENTITIES = {
    "Champion": "champion",
    "DataChampion": "data_champion",
    "DataItem": "data_item",
    "DataRune": "data_rune",
    "DragontailVersiontgz": "dragontail_versiontgz",
    "Item": "item",
    "Region": "region",
    "Version": "version",
}
