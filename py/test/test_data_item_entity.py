    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set DATA_DRAGON_TEST_DATA_ITEM_ENTID JSON to run live")
        client = setup["client"]
        ...
        data_item_ref01_data_dt0_loaded = data_item_ref01_ent.load(data_item_ref01_match_dt0, None)
...
def _data_item_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("DATA_DRAGON_TEST_DATA_ITEM_ENTID"))
