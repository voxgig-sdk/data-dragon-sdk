...
class DataChampionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DataChampionEntity(self._client, opts)
    ...
    def data_get(self) -> DataChampion:
    ...
    def match_get(self) -> DataChampion:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DataChampion:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DataChampion().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
