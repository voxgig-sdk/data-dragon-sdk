...
from datadragon_sdk.utility import register

# Load features
from datadragon_sdk.feature.base_feature import DataDragonBaseFeature
from datadragon_sdk.features import _has_feature, _make_feature
...
class DataDragonSDK:
    ...
    def __init__(self, options=None):
        ...
        from datadragon_sdk.config import shared_config
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "DataDragonSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DataDragonSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Champion(self, data=None) -> "ChampionEntity":
        ...
        from datadragon_sdk.entity.champion_entity import ChampionEntity
    ...
    def DataChampion(self, data=None) -> "DataChampionEntity":
        ...
        from datadragon_sdk.entity.data_champion_entity import DataChampionEntity
    ...
    def DataItem(self, data=None) -> "DataItemEntity":
        ...
        from datadragon_sdk.entity.data_item_entity import DataItemEntity
    ...
    def DataRune(self, data=None) -> "DataRuneEntity":
        ...
        from datadragon_sdk.entity.data_rune_entity import DataRuneEntity
    ...
    def DragontailVersiontgz(self, data=None) -> "DragontailVersiontgzEntity":
        ...
        from datadragon_sdk.entity.dragontail_versiontgz_entity import DragontailVersiontgzEntity
    ...
    def Version(self, data=None) -> "VersionEntity":
        ...
        from datadragon_sdk.entity.version_entity import VersionEntity
